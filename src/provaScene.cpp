...
class A04 : public BaseProject {
    ...
    std::vector<std::string> trkClEl = {""};
        //tb", "tdl", "tdr"};
    std::vector<std::string> trkOpEl = {""};
        //tbo", "tdlo", "tdro", "tswo"};
    std::vector<std::string> trkComEl = {""};
        //tfwl", "tfwr", "tmwl", "tmwr"};
    std::vector<std::string> trailerEl = {""};
        //apar"};
        //tt", "tbwfl", "tbwfr", "tbwrl", "tbwrr"};
	std::vector<std::string> trkScn =  {"sky","pln","apar","apar2"};
