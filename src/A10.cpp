...
struct PlanetUniformBufferObject {
    alignas(16) glm::mat4 mvpMat;
...
// **A10** Place here the initialization for the VertexDescriptor
        VDPlanet.init(this, {
                  ...
                  {0, 0, VK_FORMAT_R32G32B32_SFLOAT, offsetof(PlanetVertex, pos),
                         sizeof(glm::vec3), POSITION},
                  {0, 1, VK_FORMAT_R32G32B32_SFLOAT, offsetof(PlanetVertex, norm),
                         sizeof(glm::vec3), NORMAL},
                  {0, 2, VK_FORMAT_R32G32_SFLOAT, offsetof(PlanetVertex, UV),
                         sizeof(glm::vec2), UV},
...
// **A10** Place here the loading of the four textures
        ...
        TNorm.init(this, "textures/2k_earth_normal_map.png", VK_FORMAT_R8G8B8A8_UNORM);
...
// **A10** Add to compute the uniforms and pass them to the shaders. You need two uniforms: one for the matrices, and the other for the material parameters.
        ...
        DSPlanet.map(currentImage, &planetUbo, 0);
        ...
        planetMapParUbo.Ang = tTime * TangTurnTimeFact;
        ...
        planetMapParUbo.ShowCloud = ShowCloud;
		// The selector for showing the clouds of the uniform buffer containing the material parameters of the new object should be set to:
